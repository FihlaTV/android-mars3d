package com.olabs.motioncapture;
...
public class Orientation extends Service implements SensorEventListener {
    ...
    public class LocalBinder extends Binder{
        ...
        public Orientation getService(){ return Orientation.this; }
    ...
    public int onStartCommand(Intent intent, int flags, int startId){
        ...
        fusedOrientation[1] = 0.0f;
        fusedOrientation[2] =0.0f;
        ...
        mSensorManager.registerListener(this,
                mSensorManager.getDefaultSensor(Sensor.TYPE_MAGNETIC_FIELD), SensorManager.SENSOR_DELAY_FASTEST);
    ...
    private void getRotationVectorFromGyro( float[] gyroValues, float[] deltaRotationVector, float timeFactor){
        ...
        // Normalise the rotation vector if this is big enough to get the axis
